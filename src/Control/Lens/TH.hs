...
-- | Declare prisms as in 'makeArgTypePrisms'
...
-- | For each constructor, generate a data type name by appending \"Args\" to the
-- constructor name, and generate lenses on its members using 'lensRules',
-- except that lens names are generated by prepending "_" to the field name.
