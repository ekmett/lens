...
#if USE_RULES
{-# RULES "foldrOf' folded/foldr'" foldrOf' folded = Foldable.foldr' #-}
{-# INLINE [1] foldrOf' #-}
#else
{-# INLINE foldrOf' #-}
#endif
...
#if USE_RULES
{-# RULES "foldrMOf folded/foldrM" foldrMOf folded = Foldable.foldrM #-}
{-# INLINE [1] foldrMOf #-}
#else
{-# INLINE foldrMOf #-}
#endif
...
#if USE_RULES
{-# RULES "hasn't folded/null" hasn't folded = Prelude.null #-} -- do more of these!
{-# INLINE [1] hasn't #-}
#else
{-# INLINE hasn't #-}
#endif
