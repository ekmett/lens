...
instance (Choice p, Applicative f) => Cons p f (Deque a) (Deque a) (Deque b) (Deque b) a b where
...
instance (Choice p, Applicative f) => Snoc p f (Deque a) (Deque a) (Deque b) (Deque b) a b where
